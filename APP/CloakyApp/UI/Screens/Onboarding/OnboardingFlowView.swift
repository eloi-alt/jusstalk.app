...
// Cloaky
//
// Premium onboarding flow with 4 cinematic screens before reaching GalleryView.
...
enum OnboardingPage: Int, CaseIterable, Hashable {
    ...
    var title: String {
        ...
        case .premiumPositioning: return "Premium"
        case .cta: return "CTA"
        }
    }
}
...
struct OnboardingFlowView: View {
                ...
                VStack(spacing: 0) {
                    ...
                    TabView(selection: $currentPage) {
                        ...
                        PremiumPositioningPageView()
                            .tag(OnboardingPage.premiumPositioning)
    ...
    private var ctaButton: some View {
        Button {
            ...
            HStack {
                Text(currentPage.rawValue < totalPages - 2 ? "Continuer" : "Commencer")
                    .fontWeight(.semibold)
